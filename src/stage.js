...
// 판 위로 비워 둘 높이 여유 (칸).
//
// zMax 에서 파생시킨다. 따로 두면 상한을 올릴 때 판 머리가 조용히 잘리고,
...
//
// 주의: 층이 바뀌어 zMax 가 달라지면 fitView 를 다시 불러야 한다.
// 부르지 않으면 이전 층의 여유로 그려 판 머리가 잘린다.
export const headroom = () => stage.zMax + 1;
